...
export const APIS = [AssignmentAPIService, ImagesInternalAPIService, MenuItemAPIService, ProductAPIService, SlotAPIService, WorkspaceAPIService, WorkspaceProductAPIService, WorkspaceRolesAPIService];
